              ...
              GoRoute(
                ...
                routes: [
                  ...
                  GoRoute(
                    ...
                    routes: [
                      ...
                      GoRoute(
                        ...
                        routes: [
                          // search/post/:postId/user/:userId/collection/:collectionId
                          GoRoute(
                            path: 'collection/:collectionId',
                            pageBuilder:
                                (BuildContext context, GoRouterState state) {
                  ...
                  GoRoute(
                    ...
                    routes: [
                      // search/user/:userId/collection/:collectionId
                      GoRoute(
                        path: 'collection/:collectionId',
                        pageBuilder:
                            (BuildContext context, GoRouterState state) {
              ...
              GoRoute(
                ...
                routes: <RouteBase>[
                  ...
                  GoRoute(
                    ...
                    routes: [
                      // profile/post/:postId/user/:userId
                      GoRoute(
                        path: 'user/:userId',
                        pageBuilder:
                            (BuildContext context, GoRouterState state) {
                        ...
                        routes: [
                          // profile/post/:postId/:userId/collection/:collectionId
                          GoRoute(
                            path: 'collection/:collectionId',
                            pageBuilder:
                                (BuildContext context, GoRouterState state) {
                  ...
                  GoRoute(
                    ...
                    routes: [
                      // profile/collection/post/:postId
                      GoRoute(
                        path: 'post/:postId',
                        pageBuilder:
                            (BuildContext context, GoRouterState state) {
                        ...
                        routes: [
                          // profile/collection/post/:postId/user/:userId
                          GoRoute(
                            path: 'user/:userId',
                            pageBuilder:
                                (BuildContext context, GoRouterState state) {
                          ...
                          // profile/collection/post/:postId/comment
                          GoRoute(
                            path: 'comment',
                            pageBuilder:
                                (BuildContext context, GoRouterState state) {
