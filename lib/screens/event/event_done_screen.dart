...
class EventDoneScreen extends StatefulWidget {
  final String eventId;
  final String fromPath;

  const EventDoneScreen({
    super.key,
  ...
  @override
  State<EventDoneScreen> createState() => _EventDoneScreenState();
}

class _EventDoneScreenState extends State<EventDoneScreen>
