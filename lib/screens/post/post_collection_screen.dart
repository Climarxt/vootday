...
class PostCollectionScreen extends StatefulWidget {
  ...
  @override
  State<PostCollectionScreen> createState() => _PostCollectionScreenState();
}

class _PostCollectionScreenState extends State<PostCollectionScreen>
  ...
  void _navigateToUserScreen(BuildContext context, User user) {
    context.go(
        '/profile/collection/${widget.collectionId}/post/${widget.postId}/user/${user.id}?username=${widget.username}');
  }

  void _navigateToCommentScreen(BuildContext context) {
    context.go(
        '/profile/collection/${widget.collectionId}/post/${widget.postId}/comment?username=${widget.username}');
  }
