...
class EditCaptionEventCreatePostScreen extends StatefulWidget {
  final String userId;
  final String eventId;

  const EditCaptionEventCreatePostScreen({
    super.key,
...
class _EditLocationCreatePostScreenState
    extends State<EditCaptionEventCreatePostScreen> {
  ...
  void _handlePostButtonPressed(BuildContext context) {
    ...
    goRouter.go('/calendar/event/${widget.eventId}/create');
  }
}
